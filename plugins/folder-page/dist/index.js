...
// node_modules/.pnpm/@quartz-community+utils@htt_1939fbeebf6fe965b27fe7ad8e93343c/node_modules/@quartz-community/utils/dist/jsx.js
...
var FolderContent_default = ((options) => {
  void options;
  const FolderContent = ({ tree, fileData }) => {
    const cssClasses = fileData?.frontmatter?.cssclasses ?? [];
    const content = tree.children.length === 0 ? fileData?.description : htmlToJsx(tree);
    return /* @__PURE__ */ jsx2("div", { class: "popover-hint", children: /* @__PURE__ */ jsx2("article", { class: cssClasses.join(" "), children: /* @__PURE__ */ jsx2("div", { class: "markdown-preview-view markdown-rendered", children: content }) }) });
  };
...
// node_modules/.pnpm/@quartz-community+utils@htt_1939fbeebf6fe965b27fe7ad8e93343c/node_modules/@quartz-community/utils/dist/path.js
