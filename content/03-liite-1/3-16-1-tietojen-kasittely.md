---
title: "3.16.1 Tietojen käsittely"
id: "ich-e6-r3-a1-3.16.1"
content_type: "guideline_section"
document_id: "ich-e6-r3-fi-v1"
section_number: "3.16.1"
parent_id: "ich-e6-r3-a1-3.16"
language: "fi"
lang: "fi"
...
english_pages:
  ...
  - 40
  - 41
english_section_number: "3.16.1"
permalink: "/03-liite-1/3-16-1-tietojen-kasittely/"
aliases:
  - "Tietojen käsittely"
tags:
  - "ich-e6-r3"
...
>
> - (x) When using computerised systems in a clinical trial, the sponsor should: For systems deployed by the sponsor:
>
...
>
> - (v) Ensure that there is a process in place for service providers and investigators to inform the sponsor of system defects identified; For systems used or deployed by the investigator/institution:
>
...
>
> - (viii) The assessment should be performed before being used in the trial and should be proportionate to the importance of the data managed in the system. Factors such as data security (including measures for backup), user management and audit trails, which help ensure the protection of confidentiality and integrity of the trial data, should be considered as appropriate; For all systems:
>
